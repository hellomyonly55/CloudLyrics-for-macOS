...
从 [Releases](https://github.com/hellomyonly55/CloudLyrics-for-MacOS/releases) 下载最新版 `CloudLyrics-vX.Y.Z-universal.zip`，解压后将 `CloudLyrics.app` 移入系统“应用程序”文件夹（`/Applications`）。
...
Download the latest `CloudLyrics-vX.Y.Z-universal.zip` from [Releases](https://github.com/hellomyonly55/CloudLyrics-for-MacOS/releases), unzip it, and move `CloudLyrics.app` to the system Applications folder (`/Applications`).
